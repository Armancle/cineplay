const moviesData = [
  ...
  },
  {
    ...
    mood: ["Relaxing", "Thought-provoking", "Suspenseful"],
    trailer: "1Fg5iWmQjwk",
  ...
  },
  {
    id: "m24",
    title: "Knives Out",
    poster: "images/posters/m3.jpg",
    backdrop: "images/posters/m3.jpg",
    genre: ["Mystery", "Comedy", "Crime"],
    rating: 7.9,
    year: 2019,
    runtime: 130,
    description: "A detective investigates the death of a patriarch of an eccentric, combative family. When his death is deemed a suicide, the detective keeps investigating, slowly revealing a web of secrets.",
    mood: ["Suspenseful", "Thought-provoking", "Relaxing"],
    trailer: "qGqiHJTsRkQ",
    streaming: ["Netflix", "Prime Video"],
  ...
  },
  {
    ...
    year: 1980,
    runtime: 146,
    description: "A family heads to an isolated hotel for the winter where a sinister presence influences the father into violence, while his psychic son sees horrifying glimpses of the past and future.",
    mood: ["Scary", "Suspenseful", "Thought-provoking"],
    trailer: "S014oGZiSdI",
    streaming: ["HBO Max", "Apple TV"],
